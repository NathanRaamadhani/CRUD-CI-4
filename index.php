...
<style>
  ...
  /* #ganti {
    z-index: 1;
    background-image: url("fufufafa.jpg") !important;
  } */
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper pt-5">
      <?php if ($page == "home" || $page == "about_us"): ?>
        <!-- Gambar Utama -->
        <div id="header" class="shadow mb-4" style="background-image: url('fufufafa.jpg') !important; z-index: 3; background-size: cover; background-position: center;">
