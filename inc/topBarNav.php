...
<nav class="w-100 px-2 py-1 position-fixed top-0 bg-light " id="login-nav">
  <div class="d-flex justify-content-between w-100">
    ...
    <div>
      <?php if ($_settings->userdata('id') > 0): ?>
        ...
        <?php endif; ?>
      <?php else: ?>
        <!-- <a href="./admin" class="mx-2 text-dark ms-0" class="mx-2 text-dark">Login</a> -->
      <?php endif; ?>
    </div>
  </div>
</nav>
<nav class="main-header navbar navbar-expand navbar-light border-0 text-sm bg-gradient-light " id='top-Nav'>
  ...
  <div class="container">
    <a href="./" class="navbar-brand">
      <img src="uploads/logo.png" alt="Site Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    </a>
    <!-- <?php echo validate_image($_settings->info('logo')) ?> -->
    ...
    <div class="collapse navbar-collapse order-3" id="navbarCollapse">
      ...
      <ul class="navbar-nav">
        ...
        <?php endif; ?>
        <li class="nav-item">
          <a href="./admin" class="nav-link" style="position: absolute; top: 0; right: 0; margin:10px; font-size: 15px; font-weight: bold; color: #333;">Login</a>
        </li>
      </ul>
